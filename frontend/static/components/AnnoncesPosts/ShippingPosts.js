...
import {getShipPosts ,getCovPost} from '../../actions/CovoiturageActions';
...
export default connect(mapStateToProps , {getShipPosts , getProfiles , getCovPost})(ShippingPosts);