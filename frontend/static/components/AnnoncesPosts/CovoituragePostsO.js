...
import {getCovPosts ,getCovPost} from '../../actions/CovoiturageActions';
...
export default connect(mapStateToProps , {getCovPosts ,getCovPost,getProfiles})(CovoituragePostsO);