...
import {getTransPosts } from '../../actions/CovoiturageActions';
...
class TransportPosts extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
            <h2 className="title-Postes">Transport Posts in CHEFCHAOUEN</h2>
...
export default connect(mapStateToProps , {getTransPosts ,getProfiles})(TransportPosts);