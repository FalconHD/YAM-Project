...
onSubmit = e => {
  ...
  const Oannonce =  { lieu_depart, lieu_arrive, date_depart, date_arrive, num_tele ,ville,bagages,comment,lieu,distination,num_places};
  this.props.Add_Tannonce(Oannonce);
...
export default connect(mapStateToProps ,{getProfile , Add_Tannonce})(ConfirmO);
