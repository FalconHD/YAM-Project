  ...
  render() {
    ...
    return (
        ...
        <div className="updatecontent">
            <h2 className='h1-update-info'>Updating my Profile Info</h2>
            ...
            <button className="Profil-Update-Button" onClick={this.handleSubmit}>Update Now</button>
...
export default connect(mapStateToProps,{updateProfile,getProfile ,addProfile})(UpdateProfile);
