...
import {  putCovrPost } from '../../../actions/CovoiturageActions'
...
export class ConfirmD extends Component {
  ...
  static propTypes = {
    putCovrPost:PropTypes.func.isRequired,
...
onSubmit = e => {
  e.preventDefault();
  const  { id,lieu_depart, lieu_arrive, date_depart, date_arrive, num_tele ,ville,bagages,comment,ville_distination,num_personnes,car_model}= this.props.values;
  const Post =  { id,lieu_depart, lieu_arrive, date_depart, date_arrive, num_tele ,ville,bagages,comment,ville_distination,num_personnes,car_model};
  this.props.putCovrPost(Post.id,Post);
...
export default connect(mapStateToProps ,{getProfile , putCovrPost})(ConfirmD);
