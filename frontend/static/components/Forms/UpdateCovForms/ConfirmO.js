...
import {  putCovoPost } from '../../../actions/CovoiturageActions'
import {  getProfile } from '../../../actions/UserActions'
export class ConfirmO extends Component {


  static propTypes = {
    putCovoPost:PropTypes.func.isRequired,
...
onSubmit = e => {
  e.preventDefault();
  const  { id,lieu_depart, lieu_arrive, date_depart, date_arrive, num_tele ,ville,bagages,comment,ville_distination,num_places,car_model}= this.props.values;
  const Post =  { id,lieu_depart, lieu_arrive, date_depart, date_arrive, num_tele ,ville,bagages,comment,ville_distination,num_places,car_model};
  this.props.putCovoPost(Post.id,Post);
...
componentDidMount(){
  ...
  render() {
    const {
      values: { lieu_depart, lieu_arrive, date_depart, date_arrive,  num_tele ,ville,bagages,comment,ville_distination,num_places,car_model}
    } = this.props;
    return (
...
export default connect(mapStateToProps ,{getProfile , putCovoPost})(ConfirmO);
