...
onSubmit = e => {
  ...
  const Post =  { lieu_depart, lieu_arrive, date_depart, date_arrive, num_tele ,ville,bagages,comment,ville_distination,service};
  this.props.putShipPost(this.props.Post.id,Post);
...
export default connect(mapStateToProps ,{getProfile , putShipPost})(ConfirmD);
