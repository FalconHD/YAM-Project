...
import { Add_Oannonce } from '../../../actions/CovoiturageActions'
import {  getProfile } from '../../../actions/UserActions'
export class ConfirmO extends Component {


  static propTypes = {
    Add_Oannonce:PropTypes.func.isRequired,
...
onSubmit = e => {
  e.preventDefault();
  const  { lieu_depart, lieu_arrive, date_depart, date_arrive, num_tele ,ville,bagages,comment,ville_distination,num_places,car_model}= this.props.values;
  const Oannonce =  { lieu_depart, lieu_arrive, date_depart, date_arrive, num_tele ,ville,bagages,comment,ville_distination,num_places,car_model};
  this.props.Add_Oannonce(Oannonce);
...
export default connect(mapStateToProps ,{getProfile , Add_Oannonce})(ConfirmO);
