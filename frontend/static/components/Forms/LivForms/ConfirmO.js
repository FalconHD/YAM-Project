...
onSubmit = e => {
  ...
  const Oannonce =  { lieu_depart, lieu_arrive, date_depart, date_arrive, num_tele ,ville,bagages,comment,ville_distination,service};
  this.props.Add_Lannonce(Oannonce);
...
export default connect(mapStateToProps ,{getProfile , Add_Lannonce})(ConfirmO);
